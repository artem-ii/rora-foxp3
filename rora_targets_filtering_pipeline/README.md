...
You can also observe the stepwise filtering with code starting from step 3 in a python notebook `scripts/gene_selection_rora_treg.ipynb` directly on GitHub (doesn't work with Safari browser) 
